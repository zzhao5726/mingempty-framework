...
import top.mingempty.event.tx.mapper.PublisherRecordMapper;
...
public class PublisherRecordServiceImpl implements PublisherRecordService {
    ...
    @Override
    public void record(MeTxApplicationEvent applicationEvent) {
    ...
    public void complete(MeTxApplicationEvent applicationEvent) {
        PublisherRecordPo publisherRecordPo = new PublisherRecordPo();
        publisherRecordPo.setEventId(applicationEvent.getEventId());
    ...
    public void retry(String eventId) {
        ...
        MeTxEventPublisher.publishEventStatic(meTxApplicationEvent);
    }
