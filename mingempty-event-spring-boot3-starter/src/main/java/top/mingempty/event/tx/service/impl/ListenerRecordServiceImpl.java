package top.mingempty.event.tx.service.impl;
...
import top.mingempty.event.listener.MeTxApplicationListener;
import top.mingempty.event.model.MeTxApplicationEvent;
import top.mingempty.event.model.enums.EventStatusEnum;
import top.mingempty.event.tx.mapper.ListenerRecordMapper;
import top.mingempty.event.tx.model.ListenerRecordExample;
import top.mingempty.event.tx.model.ListenerRecordPo;
import top.mingempty.event.tx.model.PublisherRecordPo;
import top.mingempty.event.tx.service.ListenerRecordService;
...
public class ListenerRecordServiceImpl implements ListenerRecordService {
    ...
    @Override
    public String record(MeTxApplicationEvent applicationEvent, String eventListenerClass) {
        ListenerRecordPo listenerRecordPo = new ListenerRecordPo();
    ...
    public void retry(String eventListenerId) {
        ...
        MeTxApplicationListener applicationListener
                = (MeTxApplicationListener) SpringContextUtil.gainBean(Class.forName(listenerRecordPo.getEventListenerClass()));

        PublisherRecordPo publisherRecordPo = publisherRecordService.selectById(listenerRecordPo.getEventId());
        MeTxApplicationEvent meTxApplicationEvent
                = (MeTxApplicationEvent) JsonUtil.toObj(publisherRecordPo.getEventData(), Class.forName(publisherRecordPo.getEventClass()));
        ...
        applicationListener.onApplicationEvent(meTxApplicationEvent);
    }
}
