...
public class MeEventAutoConfiguration {
    ...
    public MeApplicationEventMulticaster meApplicationEventMulticaster(@Autowired(required = false) @Qualifier("eventExecutorService") ExecutorService eventExecutorService) {
