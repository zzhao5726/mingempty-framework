...
public class EntryController implements EntryApi {
    ...
    public MeRsp<EntryResultVo> list(@RequestBody MeReq<EntryQueryVo> meReq) {
        List<EntryResultVo> entryResultVos = entryService.list(meReq.getData(), meReq.getMePage());
        return MeRsp.success(entryResultVos, meReq.getMePage());
    }
