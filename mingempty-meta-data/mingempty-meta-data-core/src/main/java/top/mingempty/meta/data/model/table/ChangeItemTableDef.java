...
public class ChangeItemTableDef extends TableDef {
     ...
     * </pre>
     */
    public final QueryColumn ITEM_STATUS = new QueryColumn(this, "item_status");
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ITEM_ID, ENTRY_CODE, ENTRY_VERSION, ITEM_PARENT_CODE, ITEM_CODE, ITEM_NAME, ITEM_STATUS, ITEM_SORT, ITEM_LEVEL, ITEM_EXTRA_FIELD, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};
