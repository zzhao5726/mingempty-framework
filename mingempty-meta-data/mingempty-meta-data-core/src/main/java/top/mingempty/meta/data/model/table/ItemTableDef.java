...
public class ItemTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ITEM_ID, ENTRY_CODE, ITEM_PARENT_CODE, ITEM_CODE, ITEM_NAME, ITEM_STATUS, ITEM_SORT, ITEM_LEVEL, ITEM_EXTRA_FIELD, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};
