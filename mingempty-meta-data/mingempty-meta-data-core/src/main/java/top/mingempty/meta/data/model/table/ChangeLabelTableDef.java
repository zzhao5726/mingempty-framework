...
public class ChangeLabelTableDef extends TableDef {
     ...
     * </pre>
     */
    public final QueryColumn LABEL_STATUS = new QueryColumn(this, "label_status");
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{LABEL_ID, ENTRY_CODE, ENTRY_VERSION, LABEL_CODE, ITEM_CODE, LABEL_STATUS, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};
