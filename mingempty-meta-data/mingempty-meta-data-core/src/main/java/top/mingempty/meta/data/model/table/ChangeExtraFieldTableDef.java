...
public class ChangeExtraFieldTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{EXTRA_FIELD_ID, ENTRY_CODE, ENTRY_VERSION, EXTRA_FIELD_NAME, EXTRA_FIELD_CODE, EXTRA_FIELD_SORT, OTHER_DICT_FLAG, OTHER_ENTRY_CODE, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};
