...
public class LabelTableDef extends TableDef {
     ...
     * </pre>
     */
    public final QueryColumn ITEM_LABEL_CODE = new QueryColumn(this, "item_label_code");
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{LABEL_ID, ENTRY_CODE, ITEM_LABEL_CODE, ITEM_CODE, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};
