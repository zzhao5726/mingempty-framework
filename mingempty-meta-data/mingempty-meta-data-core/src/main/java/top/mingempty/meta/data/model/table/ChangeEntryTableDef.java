...
public class ChangeEntryTableDef extends TableDef {
     ...
     * </pre>
     */
    public final QueryColumn ENTRY_STATUS = new QueryColumn(this, "entry_status");
     ...
     * </pre>
     */
    public final QueryColumn ENTRY_CATEGORY = new QueryColumn(this, "entry_category");
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ENTRY_ID, ENTRY_CODE, ENTRY_VERSION, ENTRY_NAME, ENTRY_TYPE, ENTRY_STATUS, ENTRY_CATEGORY, ENTRY_SHARDING, SORT, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};
