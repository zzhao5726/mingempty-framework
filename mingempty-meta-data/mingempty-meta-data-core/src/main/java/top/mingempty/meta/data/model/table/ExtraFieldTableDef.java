 ...
 */
public class ExtraFieldTableDef extends TableDef {
     ...
     * 字典扩展字段信息表
     */
    public static final ExtraFieldTableDef EXTRA_FIELD_PO = new ExtraFieldTableDef();
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{EXTRA_FIELD_ID, ENTRY_CODE, EXTRA_FIELD_NAME, EXTRA_FIELD_CODE, OTHER_DICT_FLAG, OTHER_ENTRY_CODE, EXTRA_FIELD_SORT, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};

    public ExtraFieldTableDef() {
        super("", "t_meta_data_extra_field");
    }

    private ExtraFieldTableDef(String schema, String name, String alisa) {
        super(schema, name, alisa);
    }

    public ExtraFieldTableDef as(String alias) {
        String key = getNameWithSchema() + "." + alias;
        return getCache(key, k -> new ExtraFieldTableDef("", "t_meta_data_extra_field", alias));
    }
