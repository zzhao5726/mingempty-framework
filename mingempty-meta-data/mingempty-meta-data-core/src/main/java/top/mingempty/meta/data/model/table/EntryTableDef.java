...
public class EntryTableDef extends TableDef {
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ENTRY_ID, ENTRY_CODE, ENTRY_NAME, ENTRY_TYPE, ENTRY_STATUS, ENTRY_CATEGORY, ENTRY_SHARDING, SORT, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};
