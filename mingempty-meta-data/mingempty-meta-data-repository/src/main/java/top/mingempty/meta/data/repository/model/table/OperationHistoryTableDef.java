...
public class OperationHistoryTableDef extends TableDef {
     ...
     * </pre>
     */
    public final QueryColumn RESTORE_ENTRY_VERSION = new QueryColumn(this, "restore_entry_version");
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{OPERATION_HISTORY_ID, ENTRY_CODE, OPERATION_TYPE, ENTRY_VERSION, RESTORE_ENTRY_VERSION, OPERATOR_CODE, OPERATION_TIME, BATCH_ID, CREATE_TIME, UPDATE_TIME, CREATE_OPERATOR, UPDATE_OPERATOR};
