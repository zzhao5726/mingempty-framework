...
public class NacosLoggingConfigLoader implements LogConfigLoader {
    ...
    public void init() {
        try {
            String configName = environment.getProperty("me.logging.config-name", "logback.xml");
            String nacosGroup = environment.getProperty("me.logging.nacos-group", "LOGBACK_XML_GROUP");
