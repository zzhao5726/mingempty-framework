package top.mingempty.commons.data;
...
/**
 * 秒表封装<br>
 * 基于{@link  cn.hutool.core.date.StopWatch}增加记录任务的起始时间和截止时间br>
...
public class StopWatch {
    ...
    public static final class TaskInfo {
        ...
        public TaskInfo(String taskName, long timeNanos, long startTimeNanos, long endTimeNanos) {
